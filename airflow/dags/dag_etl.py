...
with DAG(
    ...
    # Task 1: Spark Bronze -> Silver (Đọc JSON từ MinIO, xử lý, lưu Parquet)
    bronze_to_silver = BashOperator(
        ...
        bash_command='docker exec vn-realestate-warehouse-spark-master-1 '
                     ...
                     '/opt/bitnami/spark/spark_jobs/etl_bronze_to_sliver.py',
    )

    # Task 2: Spark Silver -> Gold (Upsert vào PostgreSQL)
